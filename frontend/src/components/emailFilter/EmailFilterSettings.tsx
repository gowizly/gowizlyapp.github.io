        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-center h-16">
            <div className="flex items-center justify-center space-x-4">
              ...
              <h1 className="text-2xl font-bold text-gray-900">Email Filter Settings</h1>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="p-6">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="forward-email-section">
                <h3 className="text-lg font-semibold text-blue-700 mb-2">📬 Forwarding Destination</h3>
                <p className="text-sm text-gray-600 mb-3">Emails from these addresses will be automatically forwarded to:</p>
